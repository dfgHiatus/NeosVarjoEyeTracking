...
namespace NeosVarjoEye
{
	public class VarjoEyeIntegration : NeosMod
	{
		...
		[AutoRegisterConfigKey]
        public static ModConfigurationKey<bool> blinkSmoothing = new ModConfigurationKey<bool>("using_blink_smoothing", "Use Blink Smoothing", () => true);
		...
		[AutoRegisterConfigKey]
		public static ModConfigurationKey<float> minPupilSize = new ModConfigurationKey<float>("min_Pupil_Size", "Minimum Pupil Size", () => 0.003f);
		...
		public override void OnEngineInit()
		{
			...
			if (tracker.Initialize())
            {
				...
				Debug($"Initializing {0} Varjo module", tracker.GetName());
			}
			else
			{
